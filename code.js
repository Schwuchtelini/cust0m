...
'           data = data2;\r\n' +
'           if(position == p.Stream.POSITION.APPEND && !stream.reached.end) stream._loadCust0m({older: stream._oldestId}, callback, data);\r\n' +
'           else if(!stream.reached.start) stream._loadCust0m({newer: stream._newestId}, callback, data);\r\n' +
'           else \r\n' +
'           {\r\n' +
