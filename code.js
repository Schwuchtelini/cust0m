...
'   $(".comment-foot").each(function(index, elem) { if($(elem).parent().parent().next().hasClass("comment-box")) $(elem).append("<a class=\'action\' onclick=\'cust0m.commentClick(this);\'><span class=\'pict\'>c</span> rein</a>");});\r\n' +
'};\r\n' +
