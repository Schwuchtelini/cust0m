...
'   cust0m.disableLoad = true;\r\n' +
'    if(location != "new" && location != "top"){ $("#cust0m_viewed").append("<div view=\'" + location.substr(4) + "\'></div>"); $("#item-" + location.substr(4)).addClass("custom_seen");}\r\n' +
'    },\r\n' +
    ...
    function (items)
    {
       ...
       changeCss('a.thumb, a.thumb img', 'height: ' + (128 * thumbs) + 'px; width: ' + (128 * thumbs) + 'px;');
        ...
        else if(items.save_views == "M 3")
        {
            ...
            {
                changeCss('.custom_seen', '');
                changeCss('.custom_seen::after', 'background: rgba(137, 43, 43, 0.69); content: ""; height: 8px; margin-top: -8px; display: block; transform: rotate(0deg);');
            });
        }
