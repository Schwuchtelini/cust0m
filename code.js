...
'        $(".comment-foot").each(function(index, elem) { if($(elem).find(".cust0m_ups_downs_comment").length == 0) $(elem).find(".score").after("<span class=\'cust0m_ups_downs_comment\'>" + " (" + $(elem).find(".score").attr("title").replace(" up, ", "/").replace(" down",")") + "<span>"); if($(elem).find(".user").text() == op) { $(elem).addClass("custom_op"); if(cust0m.op_top && (parseInt($(elem).attr("tiefe")) == 0)) { if($(elem).parent().next().hasClass("comment-box")) $(elem).parent().next().prependTo(".comments>.comment-box"); $(elem).parent().prependTo(".comments>.comment-box"); }} });\r\n' +
...
'   $(".item-info").append("<div class=\'cust0m_item_info_bar\' style=\'width: " + $(".cust0m_item_info").width() + "px;\'><div class=\'cust0m_item_info_bar_green\' style=\'width: " + (parseInt(text.split(" ")[0]) / (parseInt(text.split(" ")[0]) + parseInt(text.split(" ")[2]))) * $(".cust0m_item_info").width() + "px;\'></div></div>");\r\n' +
