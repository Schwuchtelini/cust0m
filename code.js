...
'   debugger;\r\n' +
'   setTimeout(function() {$(".comment-foot").each(function(index, elem) { if($(elem).parent().next().hasClass("comment-box")) {$(elem).append("<a class=\'action cust0m_comment\' onclick=\'cust0m.commentClick($(this));\'><span class=\'pict\'>c</span> rein</a>"); if(cust0m.einklappen) cust0m.commentClick($(elem).find(".cust0m_comment"));}});}, 300);\r\n' +
'};\r\n' +
