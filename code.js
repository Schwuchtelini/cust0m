...
/* Für die Scrollbar*/
$("head").append('<script type="text/javascript" src="http://rawgit.com/malihu/malihu-custom-scrollbar-plugin/master/js/minified/jquery.mousewheel.min.js"></script>');
$("head").append('<script type="text/javascript" src="http://rawgit.com/malihu/malihu-custom-scrollbar-plugin/master/js/minified/jquery.mCustomScrollbar.min.js"></script>');
